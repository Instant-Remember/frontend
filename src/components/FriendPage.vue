...
export default {
  ...
  methods: {
    ...
    fetchFriendInfo() {
      ...
      axios.get(`http://158.160.92.119:8000/profile/${this.friendName}`)
        .then(response => {
    ...
    fetchFriendGoals() {
      ...
      axios.get(`http://158.160.92.119:8000/profile/${this.friendName}/goals?user_id=${this.friendName}`)
        .then(response => {
    ...
    fetchFriendSubscribers() {
      axios.get(`http://158.160.92.119:8000/profile/${this.friendName}/subscribers`)
        .then(response => {
    ...
    fetchFriendSubscriptions() {
      axios.get(`http://158.160.92.119:8000/profile/${this.friendName}/subscriptions`)
        .then(response => {
    ...
    fetchUserPosts() {
      axios.get(`http://158.160.92.119:8000/profile/${this.friendName}/posts`)
        .then(response => {
    ...
    followUser() {
      ...
      axios.get(`http://158.160.92.119:8000/profile/${this.friendName}/follow`, config)
        .then(response => {
    ...
    isSubscription() {
      ...
      axios.get(`http://158.160.92.119:8000/profile/${this.friendName}/is_subscription`, config)
        .then(response => {
    ...
    likePost(postId) {
            ...
            axios.get(`http://158.160.92.119:8000/post/${postId}/like`, {
                headers: {
    ...
    getLikes(postId) {
      axios.get(`http://158.160.92.119:8000/post/${postId}/likes`, {
        headers: {
          'accept': 'application/json'
        }
      })
    ...
    getComments(postId) {
      axios.get(`http://158.160.92.119:8000/post/${postId}/comments`, {
        headers: {
          'accept': 'application/json'
        }
      })
    ...
    addComment(postId) {
      ...
      if (newCommentText) {
        axios.post(`http://158.160.92.119:8000/comment/create`, {
          text: newCommentText,
          post_id: postId
        }, {
          headers: {
